...
export const districtsList = ["Quận 1", "Quận 3", "Quận 4", "Quận 5", "Quận 6", "Quận 7", "Quận 8", "Thủ Đức", "Quận 10", "Quận 11", "Quận 12", "Bình Thạnh", "Gò Vấp", "Phú Nhuận", "Tân Bình", "Tân Phú", "Bình Tân", "Bình Chánh", "Cần Giờ", "Củ Chi", "Hóc Môn", "Nhà Bè"];
// const wishsList = ["Nguyện vọng 1", "Nguyện vọng 2", "Nguyện vọng 3"]
export const schoolTypesList = ["Trường thường", "Trường có lớp chuyên, tích hợp", "Trường chuyên"];

export const schoolTypesObj = {
    "Trường thường" : "L03", 
    "Trường có lớp chuyên, tích hợp" : "L02", 
    "Trường chuyên" : "L01"
}

export const schoolTypesObjRev = {
    "L03" : "Trường thường",
    "L02" : "Trường có lớp chuyên, tích hợp",
    "L01" : "Trường chuyên"
}

export const normalSubjectsObj = {
    "Nguyện vọng 1": "NV1",
    "Nguyện vọng 2": "NV2",
    "Nguyện vọng 3": "NV3"
}
