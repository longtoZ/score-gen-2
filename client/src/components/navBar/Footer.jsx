...
export const Footer = () => {
  return (
    <footer className='bg-[#262626] mt-[30rem] px-[15%] pt-[5%] pb-[2%]'>
        <div className='flex justify-between gap-20'>
            <div className='w-[33%]'>
                <img src={logoTitleDark} alt="Score" className='w-[10rem] mb-6'/>
            ...
            <div className='w-[33%]'>
                ...
                <p className='text-neutral-500 mt-6 hover:text-white transition-colors ease-in duration-100'>
                    <a href="https://maps.app.goo.gl/vPbrJpWpSnAfUhsv5">
                        <LocationOnIcon/> 11 Đoàn Kết, Bình Thọ, Thành Phố Thủ Đức, Thành phố Hồ Chí Minh, Việt Nam.
                    </a>
                </p>
