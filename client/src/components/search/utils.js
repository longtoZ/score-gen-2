...
export const getAxios = (keyword, type, year) => {
    return new Promise((resolve, reject) => {
        axios.get(process.env.REACT_APP_SERVER + '/api/search', { params: { keyword, type, year } })
        .then(res => {
            resolve(res.data)
        })
        .catch(err => {
...
export const getDetailInfo = (school) => {
    return new Promise((resolve, reject) => {
        axios.get(process.env.REACT_APP_SERVER + '/api/detail', { params: { school } })
        .then(res => {
            resolve(res.data)
        })
        .catch(err => {
