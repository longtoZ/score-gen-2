                        ...
                        {result.map((item, index) => {
                            ...
                            return (
                                ...
                                {Object.entries(subjectsObj).map((subject, index2) => {
                                    return (
                                        <tr key={parseInt(`${index}${index2}`)} className={`[&:nth-child(even)]:bg-even-row-color ${index2===0 ? 'border-t-2 border-sky-600' : ''}`}>
                                            {index2 === 0 ? (
                                                <>
                                                    <td className='py-2 text-sky-600 font-bold' rowSpan={length}>{index+1}</td>
                                                    <td className='py-2' rowSpan={length}>{item[0]}</td>
                                                    <td className='py-2' rowSpan={length}>{item[1]}</td>
                                                </>
                                            ) : (
                                                <>
