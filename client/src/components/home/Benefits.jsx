            ...
            <div className="benefits-grid mt-[5rem] grid grid-cols-4 gap-8 text-center relative">
                <div className="py-6 px-6 rounded-lg bg-white bg-opacity-60 dark:bg-black dark:bg-opacity-30 backdrop-blur z-[2]">
                    ...
                    <p className="mt-2 leading-6">
                        Tra cứu thông tin trường học một cách đầy đủ với rất ít
                        thao tác.
                    </p>
                </div>
                ...
                <div className="py-6 px-6 rounded-lg bg-white bg-opacity-60 dark:bg-black dark:bg-opacity-30 backdrop-blur z-[2]">
                    ...
                    <p className="mt-2 leading-6">
                        Dữ liệu được sắp xếp và trực quan hoá qua biểu đồ, bảng,
                        đồ thị để bạn dễ dàng so sánh, phân tích và đánh giá.
                    </p>
                </div>
                ...
                <div className="py-6 px-6 rounded-lg bg-white bg-opacity-60 dark:bg-black dark:bg-opacity-30 backdrop-blur z-[2]">
                    ...
                    <p className="mt-2 leading-6">
                        Giao diện đơn giản và trực quan, dễ sử dụng, dễ dàng
                        thao tác.
                    </p>
                </div>
                ...
                <div className="py-6 px-6 rounded-lg bg-white bg-opacity-60 dark:bg-black dark:bg-opacity-30 backdrop-blur z-[2]">
                    ...
                    <p className="mt-2 leading-6">
                        Các tính năng cơ bản hoàn toàn miễn phí, không cần đăng
                        kí tài khoản để sử dụng.
                    </p>
                </div>
