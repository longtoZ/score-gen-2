...
export const DeleteMenu = () => {
    const { data, setData, showDelete, setShowDelete, setToastMessage } =
            ...
            <div className="p-8 bg-container-color rounded-lg relative">
                <div className="text-center">
                    <h1 className="text-lg text-center font-semibold my-2">
                        Xoá mục &quot;
                        {functionType[data[showDelete.index].dataType]}&quot;
                    </h1>
                ...
                <div className="flex justify-center gap-4 mt-8">
                    <button
                        className="w-[5rem] p-2 rounded-lg border-2 border-border-color text-gray-400 font-semibold"
                        onClick={handleHideDelete}
                    >
                        Hủy
                    </button>
                    <button
                        className="w-[5rem] p-2 rounded-lg bg-red-500 text-white font-semibold"
