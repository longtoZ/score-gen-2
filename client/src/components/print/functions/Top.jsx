...
export const Top = () => {
    ...
    const [top, setTop] = useState(
        mode === 'add' ? 0 : data[dataIndex].topValue,
    );
    const [position, setPosition] = useState(
        mode === 'add' ? 'highest' : data[dataIndex].positionValue,
    );
    ...
    return (
        <div>
            ...
            <section className="inputs-grid mt-[2rem] w-full grid grid-cols-3 gap-2 px-[10%]">
                <input
