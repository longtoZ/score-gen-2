...
export const ScoreRange = () => {
    ...
    const [start, setStart] = useState(
        mode === 'add' ? 0 : data[dataIndex].startValue,
    );
    const [end, setEnd] = useState(
        mode === 'add' ? 0 : data[dataIndex].endValue,
    );
    ...
    return (
        <div>
            ...
            <span className="text-red-500 text-center block w-full pt-8">
                *Điểm được đề xuất dựa trên trung bình cộng từ điểm các năm
            </span>
            <section className="options-grid mt-4 grid grid-cols-2 gap-2 px-[10%]">
                <div
                ...
                {schoolType === 'Lớp thường' ? (
                    ...
                    >
                        <p className="pr-2">{selectedSpecialWish}</p>
                        <ArrowDropDownIcon />
