...
import { CompeteContext } from '../../pages/visual/Visual';

export const SingleYear = () => {
    const { singleYear, setSingleYear } = useContext(CompeteContext);
    ...
    const handleYear = (e) => {
        e.stopPropagation();
        setSingleYear(parseInt(e.target.innerText.replace('Năm ', '').trim()));
        setShowYear(false);
    ...
    return (
        <div className='flex m-4'>
            <h1 className='font-semibold mx-2 block my-auto'>Chọn năm</h1>
            <div
