        ...
        <>
            ...
            <div className="Print py-[10rem] w-[90%] mx-auto relative">
                ...
                <p className="subtitle text-center italic text-sm text-text-subtitle-color">
                    ...
                    <br />
                    Chưa rõ?{' '}
                    <Link to="/docs/print" className="text-blue-500 underline">
                        Xem hướng dẫn
                    </Link>
                </p>
                        ...
                        return (
                            <div
                                ...
                                <div className="py-6 px-[5%]">
                                    {item.dataType === 'score-range' && (
                                        <ScoreRangeTable data={item} />
                                    )}
                                    {item.dataType === 'top' && (
                                        <TopTable data={item} />
                                    )}
                                    {item.dataType === 'year-range' && (
                                        <YearRangeTable data={item} />
                                    )}
                                    {item.dataType === 'compete' && (
                                        <CompeteTable data={item} />
                                    )}
                                    {item.dataType === 'area' && (
                                        <AreaTable data={item} />
                                    )}
                                    {item.dataType === 'group' && (
                                        <GroupTable data={item} />
                                    )}
                                    {item.dataType === 'special' && (
                                        <SpecialTable data={item} />
                                    )}
                                </div>
                            </div>
                        );
